package com.example.moattravel_2.form;
...
@Data
@AllArgsConstructor	//全てのフィールドを使うコンストラクタを自動生成
public class HouseEditForm {
	...
	private Integer price; //int型だと初期値0が入ってしまいエラーメッセージが入らない
